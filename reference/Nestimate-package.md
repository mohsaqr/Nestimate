...
Estimate, compare, and analyze dynamic and probabilistic networks using
a unified interface. Provides transition network analysis (TNA)
estimation (transition, frequency, co-occurrence, attention-weighted) as
described in Saqr, López-Pernas, Törmänen, Kaliisa, Misiejuk, and Tikka
(2025)
[doi:10.1145/3706468.3706513](https://doi.org/10.1145/3706468.3706513) ,
probabilistic network methods (correlation, partial correlation,
'graphical lasso', 'Ising') as described in Saqr, Beck, and López-Pernas
(2024)
...
Markov models, multi-cluster multi-layer (MCML) decomposition and
clustering.
